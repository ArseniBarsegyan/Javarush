...
public class Space {
    ...
    public void moveAllItems() {
        ...
        List<BaseObject> gameObjects = getAllItems();
    ...
    public List<BaseObject> getAllItems() {
        List<BaseObject> gameObjects = new ArrayList<>();
        gameObjects.addAll(Space.game.getBombs());
        gameObjects.addAll(Space.game.getRockets());
        gameObjects.addAll(Space.game.getUfos());
        gameObjects.add(Space.game.getShip());
        return gameObjects;
    ...
    public void createUfo() {
        ...
        if (ufos.isEmpty()) {
            ufos.add(new Ufo(width/2, height));
        }
    }
