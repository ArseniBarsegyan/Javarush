...
public class Util {
    ...
    public static List<Jeans> getAllJeans() {
        ...
        abstract class AbstractJeans implements Jeans {
            ...
            protected String className = "Jeans";
            ...
            public String toString() {
                return String.format("%s{id=%d, length=%d, size=%d, price=%.1f}", className, id, length, size, price);
            }
        }
        ...
        class Levis extends AbstractJeans {
            ...
            public Levis(int id, int length, int size, double price) {
                ...
                super.className = Company.Levis.toString();
            }
        ...
        class Denim extends AbstractJeans {
            public Denim(int id, int length, int size, double price) {
                super(id, length, size, price);
                super.className = Company.Denim.toString();
            }
